...
const testImageLink = "https://firebasestorage.googleapis.com/v0/b/pawsomecompanions-21c1b.appspot.com/o/UserImage%2F7vlh4A7pBhR1iDxkccjUMfyH1kj1?alt=media&token=c747220d-c808-4de1-82db-74554763362a"
        ...
        <View style={styles.card}>
            <View style={{flexDirection: "row", alignItems: "center", height:60}}>
                ...
                <View>
                    ...
                    <Text style={styles.time}> 3 hrs ago </Text>
                </View>
                <Icon size={24} name="more-vert" style={{marginLeft: 270}}></Icon>
            </View>
...
class CommunityFeed extends React.Component {
    ...
    render = () => {
        return (
            ...
            <TouchableOpacity style={styles.categoryButton} onPress={() => this.setState({filterPosts: "All"})}>
                    <Text style={this.state.filterPosts !== "All" ? styles.categoryButtonText : styles.selectedCategoryButtonText}>
                        All
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.categoryButton} onPress={() => this.setState({filterPosts: "Pet pics"})}>
                ...
                <TouchableOpacity style={styles.categoryButton} onPress={() => this.setState({filterPosts: "Pet sitting"})}>
                ...
                <TouchableOpacity style={styles.categoryButton} onPress={() => this.setState({filterPosts: "Lost pet"})}>
                ...
                <TouchableOpacity style={styles.categoryButton} onPress={() =>this.setState({filterPosts: "Event"})}>
